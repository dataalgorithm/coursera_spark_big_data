...
//    rdd.aggregate(0)(
//      (acc: Int, wikiArticle: WikipediaArticle) => if(wikiArticle.mentionsLanguage(lang)) acc+1 else acc,
//      _ + _)
  ...
  private def getLanguages(langs: List[String], wikipediaArticle: WikipediaArticle): List[String] = {
